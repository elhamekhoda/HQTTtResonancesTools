#ifndef HQTTTRESONANCESTOOLSLOADER_H_
#define HQTTTRESONANCESTOOLSLOADER_H_
 ...
 */
class HQTTtResonancesToolsLoader : public ToolLoaderBase {
public:
    /**
    ...
    ClassDef(top::HQTTtResonancesToolsLoader, 0)
};
