#ifndef MUONTTRESFAKESINCLUSIVESD0_H_
#define MUONTTRESFAKESINCLUSIVESD0_H_
 ...
 */
class MuonTtresFakesInclusiveSd0 : public top::MuonMC15 {
public:
    /**
     ...
     */
    MuonTtresFakesInclusiveSd0(double ptcut, IsolationBase *isolation);
