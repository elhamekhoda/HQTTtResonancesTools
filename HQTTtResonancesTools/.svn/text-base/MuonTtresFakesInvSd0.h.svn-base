#ifndef MUONTTRESFAKESINVSD0_H_
#define MUONTTRESFAKESINVSD0_H_
 ...
 */
class MuonTtresFakesInvSd0 : public top::MuonMC15 {
public:
    /**
     ...
     */
    MuonTtresFakesInvSd0(double ptcut, IsolationBase *isolation);
