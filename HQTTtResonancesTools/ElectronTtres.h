...
class ElectronTtres : public top::ElectronLikelihoodMC15 {
public:
    /**
     ...
     */
    //ElectronTtres(bool isPrimaryxAOD, double ptcut, bool vetoCrack, const std::string& quality, const std::string& qualityLoose, IsolationBase* isolation);
    ElectronTtres(double ptcut, bool vetoCrack, const std::string& quality, const std::string& qualityLoose, StandardIsolation* isolation);
    /**
