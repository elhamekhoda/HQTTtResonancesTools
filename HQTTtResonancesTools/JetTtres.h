...
public:
     ...
     */
    JetTtres(const double ptcut, const double etamax, const double minmass, const bool doJVTCut,  const double ghostjetPtmin = 7000., const std::string &ghostCollectionName = "");
