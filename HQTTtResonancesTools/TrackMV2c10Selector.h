#ifndef TRACKMV2C10SELECTOR_H_
#define TRACKMV2C10SELECTOR_H_
 ...
 *
 */
class TrackMV2c10Selector : public SignValueSelector {
public:
    explicit TrackMV2c10Selector(const std::string& params);
