...
MuonTtresFakesInvSd0::MuonTtresFakesInvSd0(double ptcut, IsolationBase *isolation) :
    MuonMC15(ptcut, isolation)
{
}

bool MuonTtresFakesInvSd0::passSelection(const xAOD::Muon& mu) const
{
...
bool MuonTtresFakesInvSd0::passSelectionLoose(const xAOD::Muon& mu) const
{
