...
NLargeJetTtresSTTau32Selector::NLargeJetTtresSTTau32Selector(const std::string& params) :
        SignValueSelector("NLARGEJETTTRESSTTAU32_N", params, true) {
    checkValueIsInteger();
...
bool NLargeJetTtresSTTau32Selector::apply(const top::Event& event) const {
...
//        largeJet->getAttribute("Split12", d12);
        ...
        if (largeJet->pt() > value() &&
                ...
                STL_tau32->isTagged(*largeJet) == true &&
