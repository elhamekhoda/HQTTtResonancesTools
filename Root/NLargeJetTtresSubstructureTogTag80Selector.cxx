#include "HQTTtResonancesTools/NLargeJetTtresSubstructureTogTag80Selector.h"
...
namespace top {
  ...
  NLargeJetTtresSubstructureTogTag80Selector::NLargeJetTtresSubstructureTogTag80Selector(const std::string& params) :
